...
const CandidateSingleDynamicV1 = () => {
  ...
  const fetchJobData = useCallback(async (application) => {
    ...
    await jobFetch.makeRequest(`/jobs/${application.jobData.id}/`);
    return application;
  }, []);
              ...
              <div className="inner-box">
                ...
                <div className="btn-box">
                  <a
                    ...
                    href={applicantsFetch.data?.user?.resumes[0]?.resume}
                    download={applicantsFetch.data?.user?.resumes[0]?.resume}
                  >
                    Download Resume
                  </a>
